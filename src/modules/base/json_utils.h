...
template<class ...Keys>
inline nlohmann::json::const_reference at(const nlohmann::json &json, const Keys &...key);

template<class ...Keys>
inline nlohmann::json::reference at(nlohmann::json &json, const Keys &...key);
...
inline T get(const nlohmann::json &json, const Keys &...key);
